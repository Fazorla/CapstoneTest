...
const Modal = ({ content, onClose }) => {
  return (
    <div className="z-40 fixed top-0 left-0 w-full h-full flex justify-center items-center bg-gray-800 bg-opacity-75 overflow-hidden">
      <div className="h-4/5 rounded-lg my-8 mx-8 bg-gray-800 p-4 relative lg:w-1/2 md:w-4/5 sm:w-11/12 max-h-full overflow-y-auto">
        <button
          className="absolute top-2 right-2 text-gray-200 text-3xl"
          onClick={onClose}
        >
          &times;
        </button>
